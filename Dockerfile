...
RUN yes | /home/developer/Android/cmdline-tools/latest/bin/sdkmanager --install \
    "platform-tools" "platforms;android-$ANDROID_APILEVEL" \
    "build-tools;$ANDROID_BUILDTOOLS_VERSION" \
    "emulator" \
    "system-images;android-$ANDROID_APILEVEL;google_apis;$ANDROID_ARCHITECTURE"
...
ARG ANDROID_APILEVEL
ARG ANDROID_ARCHITECTURE
RUN echo no | avdmanager create avd -n samsung_emulator -k "system-images;android-$ANDROID_APILEVEL;google_apis;$ANDROID_ARCHITECTURE"
